...
export const casings = {
  camelCase: {name: 'camelCase', convert: camelCase},
  pascalCase: {name: 'PascalCase', convert: pascalCase},
  snakeCase: {name: 'snake_case', convert: snakeCase},
  constantCase: {name: 'CONSTANT_CASE', convert: constantCase},
  kebabCase: {name: 'kebab-case', convert: kebabCase},
  trainCase: {name: 'Train-Case', convert: trainCase},
  cobolCase: {name: 'COBOL-CASE', convert: cobolCase},
  lowerCase: {name: 'lower case', convert: lowerCase},
  upperCase: {name: 'UPPER CASE', convert: upperCase},
  titleCase: {name: 'Title Case', convert: titleCase},
  sentenceCase: {name: 'Sentence case', convert: sentenceCase},
